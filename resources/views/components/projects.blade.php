<div x-data="{close: false}" x-show="projects" :class="[projects ? 'anim-test' : '', close ? 'custom-close-slide' : '']" class="w-full h-full flex flex-col min-h-40 absolute bottom-0 left-0 items-center bg-white-custom p-4 rounded-5 overflow-y-scroll overflow-x-hidden">
